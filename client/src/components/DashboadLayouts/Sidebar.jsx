...
function Sidebar({ isDrawerOpen, closeDrawer }) {
    ...
    const getNavLinkClass = (path) => {
        ...
        return `flex items-center p-2 text-base transition-all duration-200 rounded-lg ${isActive
                ...
                <nav className="space-y-4">
                    ...
                    {role === 1 && (
                        <div className="space-y-4">
                            ...
                            <NavLink to="/enrolled-projects" className={getNavLinkClass('/enrolled-projects')}>
                                <HiOutlineCheck className="w-6 h-6 mr-3" />
                                <span>Joined Projects</span>
                            </NavLink>

                            <NavLink to="/student/available-projects" className={getNavLinkClass('/student/available-projects')}>
                                <HiOutlineBriefcase className="w-6 h-6 mr-3" />
                                <span>Available Projects</span>
                            </NavLink>

                            <NavLink to="/enrolled-courses" className={getNavLinkClass('/enrolled-courses')}>
                                <HiOutlineBookOpen className="w-6 h-6 mr-3" />
                                <span>Enrolled Courses</span>
                            </NavLink>

                            <NavLink to="/available-courses" className={getNavLinkClass('/available-courses')}>
                                <HiOutlineAcademicCap className="w-6 h-6 mr-3" />
                                <span>Available Courses</span>
                            </NavLink>

                            <NavLink to="/private/messages" className={getNavLinkClass('/private/messages')}>
                    ...
                    {role === 2 && (
                        <div className="space-y-4">
                            ...
                            <NavLink to="/instructor/courses" className={getNavLinkClass('/instructor/courses')}>
                                <HiOutlineBookOpen className="w-6 h-6 mr-3" />
                                <span>My Courses</span>
                            </NavLink>

                            <NavLink to="/instructor/projects" className={getNavLinkClass('/instructor/projects')}>
                                <HiOutlineCube className="w-6 h-6 mr-3" />
                                <span>My Projects</span>
                            </NavLink>

                            <NavLink to="/instructor/ProjectManagement" className={getNavLinkClass('/instructor/ProjectManagement')}>
                    ...
                    {role === 3 && (
                        <div className="space-y-4">
                            ...
                            <div className="space-y-2">
                                <div className="px-3">
                                    <p className="text-xs font-medium text-gray-400">Users Management</p>
                                </div>

                                <NavLink to="/admin/instructors" className={getNavLinkClass('/admin/instructors')}>
                                    <HiOutlineAcademicCap className="w-6 h-6 mr-3" />
                                    <span>Instructors</span>
                                </NavLink>

                                <NavLink to="/admin/students" className={getNavLinkClass('/admin/students')}>
                                    <HiOutlineUserGroup className="w-6 h-6 mr-3" />
                                    <span>Students</span>
                                </NavLink>

                                <NavLink to="/admin/admins" className={getNavLinkClass('/admin/admins')}>
                            ...
                            <div className="space-y-2">
                                <div className="px-3">
                                    <p className="text-xs font-medium text-gray-400">Content Management</p>
                                </div>

                                <NavLink to="/admin/projects" className={getNavLinkClass('/admin/projects')}>
                                    <HiOutlineCube className="w-6 h-6 mr-3" />
                                    <span>Projects</span>
                                </NavLink>

                                <NavLink to="/admin/courses" className={getNavLinkClass('/admin/courses')}>
                                    <HiOutlineBookOpen className="w-6 h-6 mr-3" />
                                    <span>Courses</span>
                                </NavLink>

                                <NavLink to="/admin/categories" className={getNavLinkClass('/admin/categories')}>
