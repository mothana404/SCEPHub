                        ...
                        {courses.length > 0 ? (
                            courses.map((course) => (
                                <tr key={course.course_id} className="hover:bg-gray-100 transition duration-150">
                                    ...
                                    {/* Course Name */}
                                    <th scope="row" className="flex mt-4 flex-row align-middle items-center justify-center px-6 py-4 font-medium text-gray-900 whitespace-nowrap text-sm sm:text-base">
                                        {course.course_name}
                                    </th>
