...
const CreateTask = () => {
  ...
  return (
    ...
    <div class="bg-white border-4 rounded-lg shadow relative m-2">
            ...
            <form action="#">
                <div class="grid grid-cols-6 gap-6">
                    <div class="col-span-6 sm:col-span-3">
                        <label for="product-name" class="text-sm font-medium text-gray-900 block mb-2">Task title</label>
                    ...
                    <div class="col-span-6 sm:col-span-3">
                        <label for="category" class="text-sm font-medium text-gray-900 block mb-2">Due date</label>
                    ...
                    <div class="col-span-6 sm:col-span-3">
                        <label for="brand" class="text-sm font-medium text-gray-900 block mb-2">Assigned to</label>
                    ...
                    <div class="col-span-6 sm:col-span-3">
                        <label for="price" class="text-sm font-medium text-gray-900 block mb-2">File</label>
        ...
        <div class="p-6 border-t border-gray-200 rounded-b">
            <button class="text-white bg-blue-600 hover:bg-blue-800 focus:ring-4 focus:ring-cyan-200 font-medium rounded-lg text-sm px-5 py-2.5 text-center" type="submit">Save</button>
        </div>
    </div>
    </main>
    </DashboardLayout>
